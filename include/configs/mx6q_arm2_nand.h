...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"mtdparts=gpmi-nand:20m(boot),20m(kernel),-(rootfs)\0"\
		"bootcmd=nand read ${loadaddr} 0x1400000 0x400000;bootm\0"
...
#define CONFIG_ENV_SIZE         CONFIG_ENV_SECT_SIZE
	...
	/* see kobs-ng, 8M is the middle of the 16M boot partition. it's free */
