// Generated by
// ./gen_preproc.py -file ../c_sources/ip_header_template.h -file_result ../h_sources/mu.h -file_csv_reg ../sources/upower_mu_regs.csv -file_csv_btf ../sources/upower_mu_bitfields.csv -name_ip MU -dbg -info addr_base=0x100
