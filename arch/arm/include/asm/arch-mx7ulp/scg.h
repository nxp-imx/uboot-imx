...
#define SCG_PLL_CFG_BYPASS_MASK         ((0x1UL) << SCG_PLL_CFG_BYPASS_SHIFT)     /* 0: SPLL, 1: bypass */
#define SCG_PLL_CFG_PLLSEL_SHIFT        (1)
#define SCG_PLL_CFG_PLLSEL_MASK         ((0x1UL) << SCG_PLL_CFG_PLLSEL_SHIFT)     /* 0: pll, 1: pfd */
#define SCG_PLL_CFG_CLKSRC_SHIFT        (0)
#define SCG_PLL_CFG_CLKSRC_MASK         ((0x1UL) << SCG_PLL_CFG_CLKSRC_SHIFT)     /* 0: Sys-OSC, 1: FIRC */
#define SCG0_SPLL_CFG_MULT_SHIFT        (17)
#define SCG0_SPLL_CFG_MULT_MASK         ((0x1UL) << SCG0_SPLL_CFG_MULT_SHIFT)     /* 0: Multiplier = 20, 1: Multiplier = 22 */
