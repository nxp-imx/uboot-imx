...
#define CLK_ROOT_CONTROL_OFF		0x0
#define CLK_ROOT_STATUS0_OFF		0x20
...
#define CLK_ROOT_AUTHEN_OFF		0x30
#define CLK_ROOT_AUTHEN_TZ_NS_SHIFT	9
#define CLK_ROOT_AUTHEN_TZ_NS_MASK	BIT(9)
#define CLK_ROOT_AUTHEN_TZ_LOCK_SHIFT	11
#define CLK_ROOT_AUTHEN_TZ_LOCK_MASK	BIT(11)
