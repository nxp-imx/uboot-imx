...
/* iomuxc0 base address. In imx7ulp-pins.h, the offsets of pins in iomuxc0 are from 0xD000,
...
void mx7ulp_iomux_setup_pad(iomux_cfg_t pad)
{
	...
	__raw_writel(((mux_mode << IOMUXC_PCR_MUX_ALT_SHIFT) & IOMUXC_PCR_MUX_ALT_MASK),
		base + mux_ctrl_ofs);
